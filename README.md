...
| Sprint 1 Goal                   | Implementar una primera versión funcional de Octane que permita a mecánicos y dueños autenticarse, registrar/vincular vehículos, recibir datos básicos desde sensores IoT y visualizar el estado general de la motocicleta con alertas iniciales de temperatura, presión e impacto. |
...
| TS-008     | Integrar sensores con ModestIoT                | WI-013           | Configurar librería OctaneDevice                | Preparar integración base con ModestIoT y lectura inicial desde el dispositivo.                       |                 6 | Alejo Cárdenas, José Antonio       | To-Do  |
| TS-008     | Integrar sensores con ModestIoT                | WI-014           | Definir contrato de datos de sensores           | Estandarizar estructura de datos enviados por sensores hacia la aplicación.                           |                 4 | Real Calderón, Sebastián Omar      | To-Do  |
| TS-009     | Arquitectura basada en eventos                 | WI-015           | Diseñar eventos de telemetría                   | Definir eventos para temperatura, presión, impacto y estado general del vehículo.                     |                 4 | Alejo Cárdenas, José Antonio       | To-Do  |
| TS-009     | Arquitectura basada en eventos                 | WI-016           | Implementar manejadores de eventos              | Crear lógica desacoplada para procesar eventos de sensores.                                           |                 6 | Pacheco Astiguetta, Sebastián      | To-Do  |
| TS-001     | Uso de polling para detección                  | WI-017           | Implementar polling de sensores                 | Crear mecanismo de lectura periódica para capturar datos de sensores.                                 |                 5 | Alejo Cárdenas, José Antonio       | To-Do  |
| TS-001     | Uso de polling para detección                  | WI-018           | Configurar intervalo y control de errores       | Definir frecuencia de lectura y manejo de errores durante la captura de datos.                        |                 4 | Real Calderón, Sebastián Omar      | To-Do  |
| TS-002     | Lectura sensor presión                         | WI-019           | Procesar lectura de presión                     | Normalizar valores de presión y asociarlos con timestamps.                                            |                 3 | Alejo Cárdenas, José Antonio       | To-Do  |
| TS-003     | Lectura sensor temperatura                     | WI-020           | Procesar lectura de temperatura                 | Normalizar valores de temperatura en grados Celsius y asociarlos con timestamps.                      |                 3 | Alejo Cárdenas, José Antonio       | To-Do  |
| US-028     | Monitorear la temperatura de la moto           | WI-021           | Mostrar temperatura actual                      | Integrar dato de temperatura en la vista de estado del vehículo.                                      |                 4 | Real Calderón, Sebastián Omar      | To-Do  |
| US-031     | Monitorear la presión de las llantas           | WI-022           | Mostrar presión actual                          | Integrar dato de presión en la vista de estado del vehículo.                                          |                 4 | Real Calderón, Sebastián Omar      | To-Do  |
| US-015     | Alerta de Impacto Detectado                    | WI-023           | Detectar evento de impacto                      | Crear condición básica para identificar impactos recibidos desde sensores.                            |                 4 | Alejo Cárdenas, José Antonio       | To-Do  |
| US-032     | Visualizar el estado general de la moto        | WI-024           | Diseñar dashboard de estado general             | Crear estructura visual del dashboard con tarjetas de temperatura, presión, impacto y estado general. |                 6 | Romero Qwistgaard, Russell Stephen | To-Do  |
| US-032     | Visualizar el estado general de la moto        | WI-025           | Integrar dashboard con backend                  | Conectar la vista de estado general con los datos procesados por la API.                              |                 7 | Real Calderón, Sebastián Omar      | To-Do  |
| US-006     | Sistema de notificaciones interno              | WI-026           | Crear modelo de notificaciones                  | Definir estructura para alertas internas asociadas a vehículo, tipo y severidad.                      |                 4 | Alejo Cárdenas, José Antonio       | To-Do  |
| US-006     | Sistema de notificaciones interno              | WI-027           | Mostrar notificaciones en interfaz              | Crear componente visual para listar alertas recientes del vehículo.                                   |                 4 | Romero Qwistgaard, Russell Stephen | To-Do  |
| US-007     | Alerta de Temperatura Alta                     | WI-028           | Definir umbral de temperatura alta              | Crear regla para generar alerta cuando la temperatura supere el límite máximo.                        |                 2 | Alejo Cárdenas, José Antonio       | To-Do  |
| US-008     | Alerta de Temperatura Baja                     | WI-029           | Definir umbral de temperatura baja              | Crear regla para generar alerta cuando la temperatura esté por debajo del límite mínimo.              |                 2 | Alejo Cárdenas, José Antonio       | To-Do  |
| US-013     | Alerta de Presión Baja                         | WI-030           | Definir umbral de presión baja                  | Crear regla para generar alerta por presión insuficiente en llantas.                                  |                 2 | Real Calderón, Sebastián Omar      | To-Do  |
| US-014     | Alerta de Presión Alta                         | WI-031           | Definir umbral de presión alta                  | Crear regla para generar alerta por presión excesiva en llantas.                                      |                 2 | Real Calderón, Sebastián Omar      | To-Do  |
