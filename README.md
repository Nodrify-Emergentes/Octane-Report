...
- [Capítulo V: Tactical-Level Software Design](#capítulo-v-tactical-level-software-design)
  ...
  - [5.8. Bounded Context: Support \& Ticket Management](#58-bounded-context-support--ticket-management)
    - [5.8.1. Domain Layer](#581-domain-layer)
    - [5.8.2. Application Layer](#582-application-layer)
    - [5.8.3. Infrastructure Layer](#583-infrastructure-layer)
    - [5.8.4. Interface Layer](#584-interface-layer)
...
- [Capítulo VII: Production Implementation Validation \& Deploymeny](#capítulo-vii-production-implementation-validation--deploymeny)
  ...
  - [7.3 Validation Interviews](#73-validation-interviews)
    ...
    - [7.3.3 Evaluaciones segun heurísticas](#733-evaluaciones-segun-heurísticas)
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        TP:<br>
        Durante el desarrollo del TP, comuniqué al equipo los avances relacionados con los Bounded Context de Vehicle Management y Maintenance, explicando su propósito, responsabilidades principales y relación con el funcionamiento general de la solución. Además, presenté las decisiones tomadas en el diseño de la Landing Page UI, justificando la organización visual, la navegación y la forma en que esta interfaz comunica el valor del producto a usuarios técnicos y no técnicos.<br>
        TB2:<br>
        ...
        TB2:<br>
        Durante esta entrega, comuniqué al equipo las decisiones relacionadas con la configuración del entorno de desarrollo y la gestión del repositorio, explicando los procedimientos necesarios para mantener la consistencia del proyecto y facilitar el trabajo colaborativo. Asimismo, presenté la estructura utilizada para la gestión del código fuente y compartí los criterios empleados para el diseño de las entrevistas de validación, asegurando que todos los integrantes comprendieran cómo estas actividades contribuían a evaluar la aceptación de las funcionalidades implementadas.<br>
        TF:<br>
        Durante la entrega final, expuse de manera clara y objetiva al equipo y los evaluadores la arquitectura técnica y el comportamiento del Bounded Context de Wellness, detallando cómo la integración de comandos y consultas interactúa de manera óptima para el monitoreo de vehículos. Asimismo, sustenté de forma presencial los resultados del Sprint Review y la navegación de la aplicación mediante la demostración en video del software funcionando, adaptando los tecnicismos para asegurar que tanto los perfiles de negocio como los de ingeniería comprendieran cómo las recomendaciones de IA mitigan riesgos en el estado de las motocicletas urbanas.
        <br>
    ...
    <tr>
      ...
      <td>
        ...
        TP:<br>
        Documenté los Bounded Context de Vehicle Management y Maintenance de forma clara y estructurada, describiendo sus responsabilidades, elementos principales y aporte dentro de la arquitectura del sistema. Asimismo, elaboré y registré el diseño de la Landing Page UI, detallando su composición visual, secciones principales y criterios de presentación, con el fin de facilitar la comprensión del producto y mantener coherencia entre la propuesta visual y los objetivos del proyecto.<br>
        TB2:<br>
        ...
        TP:<br>
        Documenté el Bounded Context de Vehicle Wellness, describiendo sus responsabilidades principales y su aporte al monitoreo del estado del vehículo dentro de la arquitectura del sistema. Además, redacté las Style Guidelines del proyecto, estableciendo criterios visuales como paleta de colores, tipografía, componentes y lineamientos de interfaz, permitiendo que el equipo cuente con una referencia clara para mantener consistencia visual y comunicativa en el desarrollo de la solución.<br>
        TB2:<br>
        Elaboré la documentación correspondiente a la configuración del entorno de desarrollo y la gestión del código fuente, describiendo las herramientas utilizadas, la estructura del repositorio y las prácticas empleadas para el control de versiones. Además, documenté el diseño de las entrevistas de validación, definiendo preguntas alineadas con las funcionalidades implementadas durante el Sprint 1 y facilitando la recolección sistemática de retroalimentación por parte de los usuarios objetivo.<br>
        TF:<br>
        Elaboré y estructuré la documentación técnica oficial de los Web Services correspondientes al Bounded Context de Wellness en el repositorio del proyecto bajo el estándar OpenAPI. Redacté con precisión la sintaxis de las llamadas, los métodos HTTP (POST y GET), las restricciones de parámetros de ruta como VehicleId y OwnerId, y definí ejemplos formales de las respuestas JSON para el recurso WellnessSummaryResource. Adicionalmente, registré por escrito las evidencias de ejecución mediante capturas detalladas de la interacción con los endpoints utilizando datos de muestra, asociando formalmente los identificadores de commit y URLs del repositorio para garantizar la trazabilidad y la correcta revisión del Sprint.
        <br>
        Pacheco Astiguetta Sebastian
        <br>
        TB1:<br>
        ...
        TP:<br>
        Redacté la información acorde al SEO y etiquetas relacionadas con la arquitectura del proyecto y la solución IoT, documentando el proceso y las decisiones tomadas como equipo. Adicionalmente, realicé correcciones anteriores con respecto a los Bounded Context, separando la telemetría a su propio área, facilitando la identificación de funciones del event storming asociados a ésta.<br>
        TB2:<br>
...
| US-040        | Resúmen de estado de motocicletas generado por Inteligencia Artificial | Como dueño de motocicletas, quiero ver una interpretación del estado de mis motocicletas hecha por Inteligencia artificial, para ahorrar tiempo y no tener que interpretar los resultados yo mismo.                                                                                                                                                | Escenario 1: Visualización del resumen en el dashboard<br>Dado que el dueño accede al dashboard y existen análisis disponibles para sus motocicletas, cuando se muestra la lista de motocicletas, entonces el sistema presenta un resumen generado por Inteligencia Artificial para cada motocicleta junto con su información principal.<br>Escenario 2: Visualización del resumen en la pantalla de detalles<br>Dado que el dueño selecciona una motocicleta de la lista, cuando accede a la pantalla de detalles, entonces el sistema muestra el resumen generado por Inteligencia Artificial correspondiente a esa motocicleta junto con la información detallada de su estado.<br>Escenario 3: Resumen no disponible<br>Dado que una motocicleta aún no cuenta con un análisis generado por Inteligencia Artificial, cuando el dueño visualiza el dashboard o la pantalla de detalles, entonces el sistema informa que el resumen aún no se encuentra disponible y evita mostrar información incompleta.                                                                                                                                                                                                                        | EP-006  |
...
| 50        | US-040   | Resúmen de estado generado por IA                | Interpretación del estado de la moto mediante IA.           | 8            |
...
![wireframe1.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireframes/wireframe1.png)
![wireframe2.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireframes/wireframe2.png)
![wireframe3.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireframes/wireframe3.png)
![wireframe4.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireframes/wireframe4.png)
![wireframe5.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireframes/wireframe5.png)
![wireframe6.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireframes/wireframe6.png)
![wireframe7.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireframes/wireframe7.png)
![wireframe8.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireframes/wireframe8.png)
...
![wireframe-mobile1.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireframes/wireframe-mobile1.png)
![wireframe-mobile2.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireframes/wireframe-mobile2.png)
![wireframe-mobile3.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireframes/wireframe-mobile3.png)
![wireframe-mobile4.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireframes/wireframe-mobile4.png)
![wireframe-mobile5.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireframes/wireframe-mobile5.png)
![wireframe-mobile6.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireframes/wireframe-mobile6.png)
![wireframe-mobile7.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireframes/wireframe-mobile7.png)
![wireframe-mobile8.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireframes/wireframe-mobile8.png)
![wireframe-mobile9.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireframes/wireframe-mobile9.png)
![wireframe-mobile10.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireframes/wireframe-mobile10.png)
...
![usergoal1.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-userflows/usergoal1.drawio.png)
![wireflow1.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireflows/wireflow1.drawio.png)
...
![usergoal2.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-userflows/usergoal2.drawio.png)
![wireflow2.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireflows/wireflow2.drawio.png)
...
![usergoal3.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-userflows/usergoal3.drawio.png)
![wireflow3.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireflows/wireflow3.drawio.png)
...
![usergoal4.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-userflows/usergoal4.drawio.png)
![wireflow4.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireflows/wireflow4.drawio.png)
...
![usergoal5.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-userflows/usergoal5.drawio.png)
![wireflow5.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireflows/wireflow5.drawio.png)
...
![usergoal6.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-userflows/usergoal6.drawio.png)
![wireflow6.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireflows/wireflow6.drawio.png)
...
![usergoal7.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-userflows/usergoal7.drawio.png)
![wireflow7.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireflows/wireflow7.drawio.png)
...
![usergoal8.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-userflows/usergoal8.drawio.png)
![wireflow8.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireflows/wireflow8.drawio.png)

El wireflow inicia cuando el usuario presiona en la barra de navegación superior desde el panel principal y selecciona la sección Comparativas. Al acceder, la interfaz muestra las cards de los vehículos registrados, donde el usuario presiona en la card de su preferencia para ver los detalles. Finalmente, el sistema despliega una vista con la comparativa entre los vehículos seleccionados, permitiendo al usuario observar de forma clara las diferencias y similitudes en aspectos clave como rendimiento, costos y mantenimientos.

**User Goal: Como mecánico de motos, quiero progamar un mantenimiento.**

![usergoal9.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-userflows/usergoal9.drawio.png)
![wireflow9.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireflows/wireflow9.drawio.png)
...
![usergoal10.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-userflows/usergoal10.drawio.png)
![wireflow10.drawio.png](assets/images/chapter-6/applications-ux-ui-design/desktop-wireflows/wireflow10.drawio.png)
...
![wireflow-ver-dashboard.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireflows/wireflow-ver-dashboard.png)
...
![wireflow-ver-mantenimientos.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireflows/wireflow-ver-mantenimientos.png)
...
![wireflow-ver-mantenimiento.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireflows/wireflow-eliminar-gasto.png)
...
![wireflow-monitorear-metricas.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireflows/wireflow-monitorear-metricas.png)
...
![wireflow-desvincular-moto.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireflows/wireflow-desvincular-moto.png)
...
![wireflow-vincular-moto.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireflows/wireflow-vincular-moto.png)

El wireflow inicia cuando el usuario presiona en la barra lateral desde el panel principal y selecciona la sección Vehículos. Luego, el usuario presiona en la moto de su preferencia para acceder a los detalles del vehículo. Dentro de esta vista, el usuario presiona el botón Vincular, ingresa el código del mecánico y confirma la acción al presionar Solicitar. Finalmente, el sistema actualiza la interfaz y el usuario observa su moto vinculada correctamente al mecánico correspondiente.

**User Goal: Como Motociclista, quiero registrar un vehículo en mi cuenta.**

![wireflow-registrar-vehiculo.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireflows/wireflow-registrar-vehiculo.png)
...
![wireflow-ver-vehiculos.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireflows/wireflow-ver-vehiculos.png)
...
![wireflow-registrar-gastos.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireflows/wireflow-registrar-gastos.png)
...
![wireflow-ver-gastos.png](assets/images/chapter-6/applications-ux-ui-design/mobile-wireflows/wireflow-ver-gastos.png)
...
![Desktop-mockup1](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup1.png)

![Desktop-mockup2](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup2.png)

![Desktop-mockup3](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup3.png)

![Desktop-mockup4](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup4.png)

![Desktop-mockup5](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup5.png)

![Desktop-mockup6](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup6.png)

![Desktop-mockup7](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup7.png)

![Desktop-mockup8](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup8.png)

![Mobile-mockup9](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup9.png)

![Desktop-mockup10](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup10.png)

![Desktop-mockup11](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup11.png)

![Desktop-mockup13](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup13.png)

![Desktop-mockup14](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup14.png)

![Desktop-mockup16](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup16.png)

![Desktop-mockup17](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup17.png)

![Desktop-mockup18](assets/images/chapter-6/applications-ux-ui-design/desktop-app-mocks/mockup18.png)
...
![mockup1](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup1.jpg)

![mockup2](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup2.jpg)

![mockup3](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup3.jpg)

![mockup4](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup4.jpg)

![mockup5](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup5.jpg)

![mockup6](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup6.jpg)

![mockup7](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup7.jpg)

![mockup8](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup8.jpg)

![mockup9](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup9.png)

![mockup10](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup10.jpg)

![mockup11](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup11.jpg)

![mockup12](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup12.png)

![mockup13](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup13.jpg)

![mockup14](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup14.jpg)

![mockup15](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup15.png)

![mockup16](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup16.jpg)

![mockup17](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup17.jpg)

![mockup18](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup18.jpg)

![mockup19](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup19.jpg)

![mockup20](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup20.jpg)

![mockup21](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup21.jpg)

![mockup22](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup22.jpg)

![mockup23](assets/images/chapter-6/applications-ux-ui-design/mobile-app-mocks/mockup23.jpg)
...
Se muestra mediante una tabla los endpoints desarrollados durante el Sprint, considerando el sprint velocity, y se incluye una explicación de cada uno de ellos, evidenciando su funcionalidad y uso dentro de las aplicaciones.

| Endpoint                                                  | Verbo HTTP | Descripción                                                 | Parámetros                                                        | Respuesta                                          | Explicación                                                                                                                                                     |
|-----------------------------------------------------------|------------|-------------------------------------------------------------|-------------------------------------------------------------------|----------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| /authentication/sign-up                                   | POST       | Registra un usuario y un perfil                             | firstName, lastName, username, email, photoUrl, password, roles[] | ID del usuario creado                              | Confirm que el usuario se ha creado satisfactoriamente, retornando una ID que no es nula.                                                                       |
| /authentication/sign-in                                   | POST       | Inicia sesión a un usuario registrado                       | username, password                                                | Token JWT del usuario.                             | Entrega el token de sesión del usuario para autenticarse en otros endpoints en el servicio.                                                                     |
| /profiles/{profileId}                                     | GET        | Obtiene un perfil por ID                                    | profileId(path)                                                   | Detalles del perfil.                               | Se utilizan estos datos para mostrar información de un perfil específico en donde se requiera.                                                                  |
| /profiles/user                                            | GET        | Obtiene un perfil por usuario autenticado                   | -                                                                 | Detalles del perfil.                               | Se utilizan estos datos para mostrar información de un perfil específico en donde se requiera.                                                                  | 
| /profiles/users/{userId}                                  | GET        | Obtiene un perfil por ID de usuario                         | userId(path)                                                      | Detalles del perfil.                               | Se utilizan estos datos para mostrar información de un perfil específico en donde se requiera.                                                                  |
| /users                                                    | GET        | Obtiene todos los usuarios                                  | -                                                                 | Lista de usuarios.                                 | Principalmente nos ayuda a nosotros como desarrolladores, no hay un uso general dentro de las aplicaciones.                                                     |
| /users                                                    | PUT        | Actualiza un usuario autenticado                            | username, password                                                | ID del usuario,                                    | Confirma que el usuario ha cambiado sus credenciales cuando obtiene una ID igual que la de su usuario.                                                          |
| /users/{userId}                                           | GET        | Obtiene un usuario por su ID                                | userId(path)                                                      | Detalles del usuario.                              | Se utilizan estos datos para mostrar información de un usuario; sin embargo, es para uso de desarrollo y no público.                                            |
| /users/username/{username}                                | GET        | Obtiene un usuario por su nombre de usuario                 | username(path)                                                    | Detalles del usuario.                              | Se utilizan estos datos para mostrar información de un usuario; sin embargo, es para uso de desarrollo y no público.                                            |
| /users/me                                                 | GET        | Obtiene el usuario autenticado                              | -                                                                 | Detalles del usuario.                              | Se utilizan estos datos para mostrar información de un usuario de manera privada.                                                                               |
| /users/owner                                              | GET        | Obtiene la ID del dueño autenticado                         | -                                                                 | ID del dueño autenticado.                          | Se utiliza esta ID para la obtención de datos pertenecientes a otros endpoints que lo requieran y tengan difícil acceso.                                        |
| /users/mechanic                                           | GET        | Obtiene la ID del mecánico autenticado                      | -                                                                 | ID del mecánico autenticado.                       | Se utiliza esta ID para la obtención de datos pertenecientes a otros endpoints que lo requieran y tengan difícil acceso.                                        |
| /mechanics/{mechanicId}/membership                        | PUT        | Actualiza el tipo de membresía del mecánico                 | mechanicId(path), membershipType                                  | ID del mecánico.                                   | Confirma que la membresía se ha actualizado correctamente si la ID pertenece al mecánico autenticado.                                                           |
| /owners/vehicles/{vehicleId}                              | GET        | Obtiene el dueño por ID de vehículo                         | vehicleId(path)                                                   | Detalles del dueño.                                | Se utilizan estos detalles como auxiliares cuando se desea conocer al dueño del vehículo.                                                                       |
| /vehicles/{ownerId}                                       | POST       | Agrega un nuevo vehículo para un dueño                      | ownerId(path), plate, year, modelId                               | ID del vehículo y detalles completos del vehículo. | Confirma que el vehículo se ha creado correctamente si la ID no es nula y cuando el modelo se ha actualizado correctamente en base a los parámetros ingresados. |
| /vehicles/{vehicleId}                                     | GET        | Obtiene un vehículo por ID                                  | vehicleId(path)                                                   | Detalles del vehículo.                             | Se utilizan estos datos para la visualización de los detalles de un vehículo.                                                                                   |
| /vehicles/{vehicleId}                                     | DELETE     | Elimina un vehículo por ID                                  | vehicleId(path)                                                   | Código HTTP                                        | Confirma que se ha eliminado correctamente siempre y cuando sea 200.                                                                                            |
| /vehicles/owner/{ownerId}                                 | GET        | Obtiene los vehículos de un dueño con su ID                 | ownerId(path)                                                     | Lista de vehículos.                                | Se utilizan estos datos con propósito de visualización por dueño y su selección.                                                                                |
| /mechanics/{mechanicId}/assignments                       | POST       | Crea una asignación de mecánico                             | mechanicId(path)                                                  | ID de asignación.                                  | Confirma que la asignación se ha creado si la ID no es nula.                                                                                                    |
| /assignments/{assignmentId}/type                          | PATCH      | Actualiza el tipo de asignación                             | assignmentId(path), type                                          | ID de asignación.                                  | Confirma que la asignación se ha creado si la ID es igual que la original.                                                                                      |
| /assignments/{assignmentId}/status                        | PATCH      | Actualiza el estado de asignación                           | assignmentId(path), status                                        | ID de asignación.                                  | Confirma que la asignación se ha creado si la ID es igual que la original.                                                                                      |
| /assignments/code/{assignmentCode}/assign-owner/{ownerId} | PATCH      | Vincula un dueño por ID a la asignación por código          | assignmentCode(path), ownerId(path)                               | Código HTTP                                        | Confirma que la vinculación se ha realizado exitosamente siempre y cuando el código sea 200.                                                                    |
| /owners/{ownerId}/assignment                              | GET        | Obtiene una asignación por ID de dueño                      | ownerId(path)                                                     | Detalles de asignación.                            | Principalmente nos ayuda a nosotros como desarrolladores, no hay un uso general dentro de las aplicaciones.                                                     |
| /mechanics/{mechanicId}/assignments/{status}              | GET        | Obtiene las asignaciones de un mecánico por ID y por estado | mechanicId(path), status(path)                                    | Lista de asignaciones disponibles.                 | Se usan estos datos para que el mecánico visualize y reconozca los códigos disponibles a su nombre.                                                             |
| /assignments/{assignmentId}                               | GET        | Obtiene una asignación por ID                               | assignmentId(path)                                                | Detalles de la asignación.                         | Se usan estos datos para visualizar más información de una asignación.                                                                                          |
| /assignments/{assignmentId}                               | DELETE     | Elimina una asignación por ID                               | assignmentId(path)                                                | Código HTTP                                        | Confirma que la asignación se ha eliminado siempre y cuando el código sea 200.                                                                                  |
...
| Attendees (to planning meeting) | Alejo Cárdenas, José Antonio. Pacheco Astiguetta, Sebastián. Romero Qwistgaard, Russell Stephen                                                                                                                                |
| Sprint Goal & User Stories      | --------                                                                                                                                                                                                                       |
| Sprint 2 Goal                   | Habilitar el monitoreo en tiempo real de la motocicleta mediante sensores IoT (temperatura, gases, presión e impactos) y ofrecer al dueño una interpretación inteligente de ese estado a través de resúmenes generados por IA. |
...
| User Story |                                                           | Work-Item / Task |                                                |                                                                                                             |                   |                                    |        |
| Id         | Title                                                     | Id               | Title                                          | Description                                                                                                 | Estimation(Hours) | Assigned To                        | Status |
| US-028     | Monitorear la temperatura de la moto                      | WI-038           | Implementar lectura de sensor de temperatura   | Integrar sensor de temperatura del motor y exponer valores en grados Celsius al sistema.                    |                 5 | Alejo Cárdenas, José Antonio       | To-Do  |
| US-028     | Monitorear la temperatura de la moto                      | WI-039           | Generar evento de alerta por temperatura       | Implementar lógica para emitir evento de notificación cuando se excedan los umbrales definidos.             |                 4 | Alejo Cárdenas, José Antonio       | To-Do  |
| US-029     | Monitorear la contaminación emitida por el tubo de escape | WI-040           | Implementar lectura de sensores de gases       | Integrar sensores de CO₂, NH₃ y Benceno, mostrando valores en ppm.                                          |                 6 | Alejo Cárdenas, José Antonio       | To-Do  |
| US-029     | Monitorear la contaminación emitida por el tubo de escape | WI-041           | Generar evento de alerta por gases             | Implementar lógica para emitir evento de notificación cuando cualquier gas exceda su límite permitido.      |                 4 | Alejo Cárdenas, José Antonio       | To-Do  |
| US-030     | Detectar impactos cuando la moto está estacionada         | WI-042           | Implementar sensor de impacto                  | Integrar sensor de impacto para detección de golpes con la moto apagada.                                    |                 5 | Real Calderón, Sebastián Omar      | To-Do  |
| US-030     | Detectar impactos cuando la moto está estacionada         | WI-043           | Generar evento único por impacto               | Implementar lógica de umbral de sensibilidad para emitir un solo evento por golpe detectado.                |                 3 | Real Calderón, Sebastián Omar      | To-Do  |
| US-031     | Monitorear la presión de las llantas                      | WI-044           | Implementar lectura de sensor de presión       | Integrar sensor de presión de llantas y mostrar valores en hPa.                                             |                 5 | Real Calderón, Sebastián Omar      | To-Do  |
| US-031     | Monitorear la presión de las llantas                      | WI-045           | Generar evento de alerta por presión           | Implementar lógica para emitir evento cuando la presión salga del rango seguro.                             |                 4 | Real Calderón, Sebastián Omar      | To-Do  |
| US-032     | Visualizar el estado general de la moto                   | WI-046           | Crear dashboard de estado general              | Diseñar e implementar vista que muestre simultáneamente temperatura, gases, presión e impactos.             |                 6 | Romero Qwistgaard, Russell Stephen | To-Do  |
| US-032     | Visualizar el estado general de la moto                   | WI-047           | Manejar fallos de sensores en el dashboard     | Implementar lógica para continuar mostrando valores disponibles cuando un sensor falle.                     |                 3 | Romero Qwistgaard, Russell Stephen | To-Do  |
| TS-002     | Lectura de sensor de presión de llantas                   | WI-048           | Implementar rutina periódica de presión        | Programar lectura periódica de presión con precisión de ±1 PSI y marcado de lecturas anómalas.              |                 5 | Alejo Cárdenas, José Antonio       | To-Do  |
| TS-003     | Lectura de sensor de temperatura del motor                | WI-049           | Implementar rutina periódica de temperatura    | Programar lectura periódica de temperatura con precisión de ±2°C y flag de sobrecalentamiento.              |                 5 | Alejo Cárdenas, José Antonio       | To-Do  |
| TS-005     | Registro de métricas en memoria local                     | WI-050           | Implementar almacenamiento local de métricas   | Guardar lecturas de sensores con timestamp y tipo de sensor en memoria local del dispositivo.               |                 6 | Pacheco Astiguetta, Sebastián      | To-Do  |
| TS-005     | Registro de métricas en memoria local                     | WI-051           | Implementar política de limpieza de memoria    | Eliminar automáticamente el 10% de registros más antiguos al alcanzar la capacidad máxima.                  |                 3 | Pacheco Astiguetta, Sebastián      | To-Do  |
| TS-006     | Sincronización de datos con la aplicación móvil           | WI-052           | Implementar sincronización de métricas         | Transferir registros pendientes hacia la aplicación móvil en lotes por timestamp y tipo de métrica.         |                 6 | Pacheco Astiguetta, Sebastián      | To-Do  |
| TS-006     | Sincronización de datos con la aplicación móvil           | WI-053           | Manejar reintentos de sincronización           | Implementar reenvío diferencial de datos no sincronizados ante fallas de conexión.                          |                 4 | Pacheco Astiguetta, Sebastián      | To-Do  |
| US-040     | Resúmen de estado de motocicletas generado por IA         | WI-054           | Integrar generación de resumen IA por vehículo | Conectar servicio de IA para generar un resumen del estado de la moto a partir de las métricas registradas. |                 6 | Pacheco Astiguetta, Sebastián      | To-Do  |
| US-040     | Resúmen de estado de motocicletas generado por IA         | WI-055           | Mostrar resumen IA en dashboard y detalle      | Integrar el resumen generado en la vista de lista y en la vista de detalles de cada motocicleta.            |                 5 | Romero Qwistgaard, Russell Stephen | To-Do  |
| US-040     | Resúmen de estado de motocicletas generado por IA         | WI-056           | Manejar caso de resumen no disponible          | Mostrar mensaje informativo cuando aún no exista un análisis de IA generado para la motocicleta.            |                 2 | Romero Qwistgaard, Russell Stephen | To-Do  |
| General    | Validación del Sprint                                     | WI-057           | Pruebas funcionales de sensores y alertas      | Validar lecturas de sensores, generación de eventos y visualización correcta en el dashboard.               |                 5 | Pacheco Astiguetta, Sebastián      | To-Do  |
